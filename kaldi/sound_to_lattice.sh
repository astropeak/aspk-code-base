...
# for yesno eg
graphdir=~/github/kaldi/egs/yesno/s5/exp/mono0a/graph_tgpr
model=/Users/astropeak/github/kaldi/egs/yesno/s5/exp/mono0a/final.mdl
...
feats="ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/utt2spk scp:$sdata/cmvn.scp scp:$sdata/feats.scp ark:- | add-deltas $delta_opts ark:- ark:- |"
...
# feats="ark,s,cs:apply-cmvn $cmvn_opts scp:$sdata/cmvn.scp scp:$sdata/feats.scp ark:- | add-deltas $delta_opts ark:- ark:- |"
